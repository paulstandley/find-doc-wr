                    ...
                    if (this.ns = "CrispLoader", this.__console = {
                        ...
                        if ("interactive" === document.readyState || "complete" === document.readyState) this.init();
                            ...
                            window.addEventListener("DOMContentLoaded", function() {
                                ...
                                "function" == typeof i && i(), "interactive" !== document.readyState && "complete" !== document.readyState || setTimeout(function() {
                                    t.init()
                ...
                try {
                    if (this.__website_id && this.__initialize_fired !== !0) {
                        ...
                        var i = function() {
                            ...
                            r = function r() {
                                setTimeout(function() {
                                    t.__check_timeout -= t.__check_every, "undefined" != typeof window[t.__dollar_crisp] && "function" == typeof window[t.__dollar_crisp].__init && i() === !0 ? (t.__console.info(t.ns + "." + e, "Dependencies loaded"), _.parentNode.removeChild(_), window[t.__dollar_crisp].__init({
                                    ...
                                    })) : t.__check_timeout > 0 ? r() : t.__console.error(t.ns + "." + e, "Could not load dependencies")
                                }, t.__check_every)
                            };
                        r()
                    }

Function && Function.prototype && Function.prototype.bind && (/MSIE ([6789]|10)/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(), window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || function(t) {
            ...
            if (n) e.push(n[2]);
                ...
                u.charset = "utf-8", u.timeout = 120, i.nc && u.setAttribute("nonce", i.nc), u.src = function(t) {
                    return i.p + "js/" + ({
                        ...
                        0: "cb38d07468ec6018c11772ae620672f0",
                        2: "0c36c1e43bc06e9b279828efd2bb998b",
                        3: "9a57558490548c2dde66afe19af6c010",
                        4: "56ce28ea0b7fd55c42395eac2890a621",
                        5: "93b59f1eed71c2eccf15826dc723006e",
                        6: "9ef4ef7dc9363096f08cc20d7b499dcb",
                        7: "bf4db19b04483c3902c80db232e45267",
                        8: "32281c46d4a685a1acbfbae8deacde45"
                    }[t] + ".js"
                }(t), s = function(e) {
    ...
    t.exports = function(t, e, n) {
        ...
        return t = t || [], e = e || {}, d = "ƒ(" + t.join(", ") + ", target, [options]);",
            function() {
                var f, l, h, p, m = Array.prototype.slice.apply(arguments, [0, t.length]),
                    v = Array.prototype.slice.apply(arguments, [t.length]);
                return v.forEach(function(t) {
                    t && (t.nodeType !== Node.ELEMENT_NODE ? c.isType("function", t) ? f = t : c.isType("object", t) && (l = t) : h = t)
                }), m.length !== t.length || 0 === v.length ? (f && c.async(function() {
                    f(!1)
                }), r.reject(new Error("Not enough parameters. Expected: " + d))) : h ? (l = c.aug({}, l || {}, e), t.forEach(function(t) {
                    l[t] = m.shift()
                }), u.asBoolean(l.dnt) && i.setOn(), p = a.getExperiments().then(function(t) {
                    return o.addWidget(n(l, h, void 0, s.isHorizonTweetEnabled(t)))
                }), f && p.then(f, function() {
                    f(!1)
                }), p) : (f && c.async(function() {
                    f(!1)
    ...
    t.exports = function(t, e, n, d) {
        var f;
        return d ? (f = i.createElement("div"), new r(s, o, c.TWEET, t, e, n, {
            sandboxWrapperEl: f
    ...
    t.exports = {
        tweetButtonHtmlPath: "/widgets/tweet_button.6a44a9d26983bbb5b04ae399f9e496fe.{{lang}}.html",
        followButtonHtmlPath: "/widgets/follow_button.6a44a9d26983bbb5b04ae399f9e496fe.{{lang}}.html",
        hubHtmlPath: "/widgets/hub.html",
        widgetIframeHtmlPath: "/widgets/widget_iframe.6a44a9d26983bbb5b04ae399f9e496fe.html",
